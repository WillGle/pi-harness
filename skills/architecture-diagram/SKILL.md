...
**Priority:** readability and faithful relationships > decorative density. Reuse repo colors; do not impose white canvas/black text, a date, a word limit or CPDA's palette on another project. The diagram's labels and line patterns must still make sense without color.
